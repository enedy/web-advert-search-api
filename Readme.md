# ASP.NET Core Web API Serverless Application with ElasticSearch
...
WORKDIR /src
COPY ["WebAdvert.Search.Api.csproj", "WebAdvert.Search.Api/"]
RUN dotnet restore "WebAdvert.Search.Api/WebAdvert.Search.Api.csproj"

WORKDIR "/src/WebAdvert.Search.Api"
COPY . .
RUN dotnet build "WebAdvert.Search.Api.csproj" --configuration Release --output /app/build

FROM build AS publish
RUN dotnet publish "WebAdvert.Search.Api.csproj" \
...
Execute unit tests
```
    cd "WebAdvert.Search.Api/test/WebAdvert.Search.Api.Tests"
    dotnet test
```

Deploy application
```
    cd "WebAdvert.Search.Api/src/WebAdvert.Search.Api"
